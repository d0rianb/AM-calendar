      ...
      case CalendarView.timelineDay:
        {
          ...
          if (headerDateFormat != null) {
            return capitalize(DateFormat(headerDateFormat, widget.locale)
                .format(headerDate)
                .toString());
          }
          return DateFormat(monthFormat, widget.locale)
  ...
  List<CustomPainterSemantics> _getSemanticsBuilder(Size size) {
    ...
    if (!isMonthLabel) {
      if (!isDisplayDate) {
        ...
        accessibilityText =
            DateFormat('MMMM dd', locale).format(startDate).toString() +
                'to' +
                DateFormat('MMMM dd', locale).format(endDate!).toString();
      } else {
