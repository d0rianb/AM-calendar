import 'package:am_calendar/lise-request.dart';
...
void main() {
  runApp(App());
  // print(await LiseRequest.getJSESSIONID());
}
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: false
          ...
          : null,
      body: Calendar(List.from(widget.events.map((event) => CalendarEvent.fromLiseObject(event)))).build(context),
    );
  }
}
