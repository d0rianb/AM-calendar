...
class CalendarItem extends Hero {
  ...
  CalendarItem(this.event, this.size, this.expanded) : super(
      tag: event.id,
      child: DefaultTextStyle(
        ...
        child: Center(
          child: FittedBox(
            key: Key(event.id),
            fit: event.isAllDay ? BoxFit.none : BoxFit.contain,
            child: Container(
...
// hack to solve issue with fittedbox
class AllDayCalendarItem extends Hero {
  final CalendarEvent event;
  final Size size;
  final bool expanded;
  ...
  AllDayCalendarItem(this.event, this.size, this.expanded) : super(
    tag: event.id,
    child: DefaultTextStyle(
      style: const TextStyle(
        decoration: TextDecoration.none,
